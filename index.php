   ...
   <div class="container row">
      ...
      <div class="container-fluid col-3" style="margin-left: 30px;">
         <div class="container text-center" style="margin:40px auto 100px 50px;">
            <button class="btn btn-info btn-block" style="width:300px;height:60px;"> <a href="inicio.php" class="text-white" style="text-decoration: none;">Venha nos conhecer!</a></button>
         </div>
